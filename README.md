# Gaussian Process Regression and its application in reliability analysis - Final year project
...
This repository includes scratch-built implementations for the following strategies:
